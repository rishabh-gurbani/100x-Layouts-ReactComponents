...
export default function TabNavigator ({
    ...
    const tabComponents = tabs.map(tab => {
        ...
        return (
            <button key={tab} onClick={() => setActiveTab(tab)} className="flex flex-col items-center justify-center hover:bg-neutral-800 w-2/4 text-center cursor-pointer relative">
